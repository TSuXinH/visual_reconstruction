...
from models.base import BaseModule, BaseModel
...
class AEMSP(AE):
    ...
    def loss(self, data, dataset=0, accumulate_grad=True, chunk_size=200):
        ...
        for chunk in range(n_chunks):
            ...
            # mse loss
            loss_mse = mse(x_in, x_hat, m_in)

            # msp loss
            loss_msp = mse(y_in, y_hat) + \
                mse(z, torch.matmul(y_hat, self.projection.weight))
